...
bundles_condition <- fhir_search(request = request_conditions, body = body_conditions, max_bundles = 20)
# no saving necessary
...
bundles_patient <- fhir_search(request = request_patients, body = body_patient, max_bundles = 20)
...
bundles_condition <- fhir_search(request = request_conditions, max_bundles = 20)
...
bundles_observation <- fhir_search(request = request_observations, body = body_observation, max_bundles = 20)
...
if(contains_ids(medicationAdministration_ids)) {
  ...
  bundles_medication <- fhir_search(request = request_medications, body = body_medication, max_bundles = 20)
} else {
